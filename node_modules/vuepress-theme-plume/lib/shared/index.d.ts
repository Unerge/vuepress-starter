...
import { GitPluginPageData, ContributorsOptions, ChangelogOptions } from '@vuepress/plugin-git';
export { GitChangelog, GitContributor } from '@vuepress/plugin-git';

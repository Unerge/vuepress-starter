<template><div><h1 id="复习资料" tabindex="-1"><a class="header-anchor" href="#复习资料"><span>复习资料</span></a></h1>
<hr>
<div class="hint-container tip">
<p class="hint-container-title">注意</p>
<p>（移动设备）点击左上角的<code v-pre>≡</code>以显示侧边栏.</p>
</div>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>现在您可以通过该复习资料完成对期末考试的复习(废话).</p>
<p>已加入折叠/展开功能, 您可以先记忆展开的知识要点, 然后再折叠抽查自己是否有效记忆该内容.这有助于提升您的复习效率.</p>
</div>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
...
<summary>展开/收缩</summary>
<ol>
<li><strong>斯密认为, 劳动是国民财富的重要源泉之一</strong>.</li>
<li><strong>1856</strong> 年出生的 <strong>泰勒</strong> 被后人称为 &quot; <strong>科学管理之父</strong> &quot;.</li>
</ol>
</details>
<h3 id="一国财富的多寡-取决于两个因素" tabindex="-1"><a class="header-anchor" href="#一国财富的多寡-取决于两个因素"><span>一国财富的多寡, 取决于两个因素:</span></a></h3>
<details id="my-details">
<summary>展开/收缩</summary>
<ul>
<li>一是该国从事有用劳动的居民在总人口所占的比重;</li>
<li>二是这些人的劳动熟练程度、劳动技巧和判断力的高低. 财富的增加可以提高人民的幸福程度, 而提高劳动者的技巧的熟练程度, 从而提高劳动生产率, 则是增加一国物质财富的重要途径. 劳动分工有助于这个目标的实现.</li>
</ul>
</details>
<h3 id="为什么-同样数量的劳动者因为有了劳动分工就能完成更多量的工作呢-斯密认为-原因有三个" tabindex="-1"><a class="header-anchor" href="#为什么-同样数量的劳动者因为有了劳动分工就能完成更多量的工作呢-斯密认为-原因有三个"><span>为什么&quot;同样数量的劳动者因为有了劳动分工就能完成更多量的工作呢&quot;? 斯密认为, 原因有三个:</span></a></h3>
<details id="my-details">
<summary>展开/收缩</summary>
<ul>
<li>第一, 劳动分工可以使工人重复完成简单的操作, 从而可以提高劳动熟练程度, 提高劳动效率;</li>
<li>第二, 分工节省了通常由一种工作转到其他工作所损失的时间;</li>
...
<ol>
<li>
<p>学习管理学, 首先可以让我们了解管理的一般规律.</p>
</li>
<li>
<p>学习管理学, 不仅可以帮助我们形成理性分析能力, 而且可以提升我们以直觉判断为基础的决策或决断能力.</p>
</li>
<li>
<p>学习管理学, 归根结底, 是要指导我们的管理实践, 是要提升我们的管理水平.</p>
</li>
</ol>
</details>
...
<p>   <strong>第二</strong> , 组织具有明确的目标.</p>
...
<ol>
<li>
<p>为管理的连续性奠定了基础。因为权力是赋予职务而不是个人的，因此权力的运用不会因领导人的更换而中断。</p>
</li>
<li>
<p>合理性。担任职务的人员是按照完成任务所需的能力来挑选的。</p>
</li>
<li>
<p>领导人可以借助法律手段来保证权力的行使。</p>
</li>
<li>
<p>所有权力都有明确的规定，而且是按照组织所需的职能加以详细划分的。</p>
</li>
</ol>
</details>
...
<tbody>
<tr>
<td style="text-align:left">情报活动</td>
<td style="text-align:left">设计活动</td>
<td style="text-align:left">抉择活动</td>
<td style="text-align:left">审查活动</td>
</tr>
</tbody>
</table>
<blockquote>
<p>西蒙认为，人们习惯上运用 &quot;最优&quot; 或 &quot;绝对的理性&quot; 作为决策的准则。根据这个准则进行决策需要三个前提:</p>
</blockquote>
<p>   <strong>一</strong> 是决策者对所有可供选择的方案及其执行结果无所不知。</p>
...
<summary>展开/收缩</summary>
<blockquote>
<p>明茨伯格指出: 无论企业采用的具体协调方法有多少种, 都可以归纳为六种基本的机制</p>
</blockquote>
<ol>
<li>相互调适</li>
<li>直接监督</li>

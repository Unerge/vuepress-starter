...
// node_modules/@vuepress/plugin-watermark/lib/client/index.js
import { useRoutePath as b, useSiteLocaleData as P, withBase as S, usePageFrontmatter as j } from "vuepress/client";

// node_modules/watermark-js-plus/dist/index.esm.js
...
var WatermarkCanvas = (
  ...
  function() {
    ...
    WatermarkCanvas2.prototype.setStyle = function(ctx) {
      ...
      if (isFunction2(this.options.extraDrawFunc)) {
...
var E = (e, t, n = 500) => {
  const a = b(), p = P();
  onMounted(() => {
    const s = new Watermark(), u = (c) => {
      var _a;
      const o = { content: p.value.title, fontColor: "#76747f", globalAlpha: c.mode === "blind" ? 5e-3 : 0.165, ...c };
      ((_a = o.image) == null ? void 0 : _a.startsWith("/")) && (o.image = S(o.image)), toValue(t) && s.changeOptions(o);
    };
    watch([t, a], () => nextTick(() => {
      t.value ? wait(n).then(() => {
        u(toValue(e));
      }) : s.destroy();
    }), { immediate: true }), isRef(e) && watch(e, u);
  });
};
var f = Symbol(__VUEPRESS_DEV__ ? "watermark" : "");
var i = ref({});
var O = (e) => {
  isRef(e) ? watch(e, (t) => {
    i.value = t;
  }, { immediate: true }) : isFunction(e) ? watch(e, (t) => {
    i.value = t;
  }) : i.value = e;
};
var R = (e) => {
  const t = inject(f), n = j();
  return computed(() => {
    const { watermark: a } = n.value;
    return { ...toValue(e), ...t.value, ...isPlainObject(a) ? a : {} };
  });
};
var V = (e) => {
  e.provide(f, i);
...
export {
  O as defineWatermarkConfig,
  V as injectWatermarkConfig,
  E as setupWatermark,
...
watermark-js-plus/dist/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=@vuepress_plugin-watermark_client.js.map
